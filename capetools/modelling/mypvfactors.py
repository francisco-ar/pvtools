...
__all__ = ['system_def', 'get_index', 'plot_idx', 'debug_pvarray', 'join_sun', 'get_data']
...
# Cell
def get_data(tmy_file:File, pvarray_params:dict, reader:str='pvgis', coerce_year:int=2018):
