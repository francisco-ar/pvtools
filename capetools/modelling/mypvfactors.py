...
__all__ = ['system_def', 'get_index', 'plot_idx', 'fit_and_plot', 'join_sun', 'get_data', 'run_simulation',
           'individual_report']
...
# Cell
def run_simulation(data: DataFrame, pvarray_params: dict)->OrderedPVArray:
